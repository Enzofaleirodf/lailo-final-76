...
const FilterContent: React.FC = () => {
  ...
  // Manipulador de alterações de filtro - comportamento consistente entre desktop e mobile
  ...
  return (
    <div className="flex flex-col gap-0" role="region" aria-label="Filtros de busca">
