...
const MobileFilterBar = ({
  ...
  return <div className="sticky top-0 z-10 w-full pb-4 pt-2 bg-gradient-to-br from-white to-purple-50 shadow-sm px-0 mt-0 mb-6 py-0">
      <div className="flex rounded-lg border border-gray-200 shadow-sm overflow-hidden w-full bg-white">
        ...
        <button onClick={() => onTabChange('vehicle')} className={cn("w-11 h-10 flex items-center justify-center text-sm font-medium transition-colors", activeTab === 'vehicle' ? "bg-gradient-to-r from-purple-600 to-purple-700 text-white" : "bg-white text-gray-700 hover:bg-gray-50")} aria-label="Veículos">
