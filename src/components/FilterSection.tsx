...
const FilterSection: React.FC<FilterSectionProps> = ({
  ...
  const footerContent = <div className="flex gap-3">
      <Button variant="outline" className="flex-1 h-10 bg-white border-gray-300" onClick={() => handleOpenChange(false)}>
        Cancelar
      </Button>
      <Button className="flex-1 h-10 bg-brand-600 hover:bg-brand-700" onClick={handleApplyFilters}>
  ...
  if (!isMobile) {
    return <div className="w-full lg:w-[448px] bg-gradient-to-br from-white to-brand-50 rounded-lg border border-gray-200 p-4 flex flex-col shadow-sm z-10">
        <FilterContent />
      </div>;
  }
