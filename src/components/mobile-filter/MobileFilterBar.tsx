...
const MobileFilterBar: React.FC<MobileFilterBarProps> = ({
  ...
  return <div role="navigation" aria-label="Opções de filtro e ordenação" className="fixed top-0 left-0 right-0 z-30 w-full pt-3 pb-0 mt-0 px-1 bg-[#fbfbfc] shadow-sm">
