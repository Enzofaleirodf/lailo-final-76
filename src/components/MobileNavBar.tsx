...
const MobileNavBar = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[150] bg-white border-t border-gray-200 shadow-lg w-full mobile-nav-bar body:has(.modal-open):hidden" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
