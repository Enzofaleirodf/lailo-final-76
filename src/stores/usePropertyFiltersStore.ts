...
// Define a interface para a store de filtros de imóveis
interface PropertyFilterStore extends FilterStoreState {
  // Actions
...
// Estado inicial para filtros de imóveis
const initialPropertyFilterState: FilterState = {
...
export const usePropertyFiltersStore = create<PropertyFilterStore>()(
  devtools(
    (set, get) => ({
      filters: initialPropertyFilterState,
      ...
      updateFilter: (key, value) => {
        set((state) => {
          ...
          // Se a categoria mudar, resetar os tipos de propriedade
          if (key === 'category') {
